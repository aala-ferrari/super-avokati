...
LEGAL_DOCUMENTS: tuple[LegalDocument, ...] = (
    ...
    LegalDocument(code="ligji_gjykata_kushtetuese", title_sq="Ligji nr. 8577/2000 «Për organizimin dhe funksionimin e Gjykatës Kushtetuese të Republikës së Shqipërisë»", title_en="Constitutional Court Law", area="Kushtetues", url="https://qbz.gov.al/alfresco/webdav/Aktet/ligj/kuvendi-i-shqiperise/2000/02/10/8577/cons-2021-05-17/ligj-2000-02-10-8577_perditesuar-korrigjuar.pdf", local_pdf="al_qbz/ligji_gjykata_kushtetuese.pdf", volatility="STABLE"),
    LegalDocument(code="ligji_pergjegjesia_administrates", title_sq="Ligji nr. 8510/1999 «Për përgjegjësinë jashtëkontraktore të organeve të administratës shtetërore»", title_en="Non-contractual Liability of State Administration", area="Civil", url="https://qbz.gov.al/alfresco/webdav/Aktet/ligj/kuvendi-i-shqiperise/1999/07/15/8510/cons-2026-03-18/ligj-1999-07-15-8510%20perditesuar%201.pdf", local_pdf="al_qbz/ligji_pergjegjesia_administrates.pdf", volatility="STABLE"),
    LegalDocument(code="ligji_marredheniet_juridiksionale", title_sq="Ligji nr. 10193/2009 «Për marrëdhëniet juridiksionale me autoritetet e huaja në çështjet penale»", title_en="Judicial Cooperation in Criminal Matters", area="Penal", url="https://qbz.gov.al/alfresco/webdav/Aktet/ligj/kuvendi-i-shqiperise/2009/12/03/10193/cons-2021-08-09/ligj-2009-12-03-10193.pdf", local_pdf="al_qbz/ligji_marredheniet_juridiksionale.pdf", volatility="STABLE"),
    LegalDocument(code="ligji_shpronesimi", title_sq="Ligji nr. 8561/1999 «Për shpronësimet dhe marrjen në përdorim të përkohshëm të pasurisë, pronë private, për interes publik»", title_en="Expropriation Law", area="Prone", url="https://qbz.gov.al/alfresco/webdav/Aktet/ligj/kuvendi-i-shqiperise/1999/12/22/8561/cons-2020-03-26/ligj-1999-12-22-8561-perditesuar.pdf", local_pdf="al_qbz/ligji_shpronesimi.pdf", volatility="STABLE"),
    LegalDocument(code="ligji_vetqeverisja_vendore", title_sq="Ligji nr. 139/2015 «Për vetëqeverisjen vendore»", title_en="Local Self-Government Law", area="Administrativ", url="https://qbz.gov.al/alfresco/webdav/Aktet/ligj/kuvendi-i-shqiperise/2015/12/17/139/cons-2019-09-19/LIGJ_139-2015_17122015_p%C3%ABrdit%C3%ABsuar.pdf", local_pdf="al_qbz/ligji_vetqeverisja_vendore.pdf", volatility="MEDIUM"),
    ...
    # v9.391 — la legge a cui rimandano i nenet 283-284/c KP («në kundërshtim me ligjin», «pa leje dhe autorizim sipas
    # ligjit»): classificazione in gruppi e liste delle Convenzioni, lëndë të kontrolluara (Lista A: ketamina, GBL, N2O),
    # autorizzazioni, ricette, sanzioni; e la 61/2023 (cannabis per uso medico e industriale; il neni 44 abroga le norme
    # contrarie della 7975). Le liste delle sostanze sono immagini nel .docx: nel corpus c'è la parte in testo («shtojca»).
    LegalDocument(code="ligji_lendet_narkotike", title_sq="Ligji nr. 7975/1995 «Për lëndët narkotike, psikotrope dhe të kontrolluara»", title_en="Narcotic, Psychotropic and Controlled Substances Law", area="Penal", url="https://qbz.gov.al/alfresco/webdav/Aktet/ligj/kuvendi-i-shqiperise/1995/07/26/7975/cons-2026-02-20/ligj-1995-07-26-7975%20-i%20p%c3%abrdit%c3%absuar%209.docx", local_pdf="al_qbz/ligji_lendet_narkotike.docx", volatility="MEDIUM", last_amendment_date="2026-02-20"),
    LegalDocument(code="ligji_kanabisi_mjekesor", title_sq="Ligji nr. 61/2023 «Për kontrollin e kultivimit dhe përpunimit të bimës së cannabis-it dhe prodhimit të nënprodukteve të saj për qëllime mjekësore dhe industriale»", title_en="Medical and Industrial Cannabis Law", area="Penal", url="https://qbz.gov.al/alfresco/webdav/Aktet/ligj/kuvendi-i-shqiperise/2023/07/21/61/base/ligj-2023-07-21-61.docx", local_pdf="al_qbz/ligji_kanabisi_mjekesor.docx", volatility="MEDIUM", last_amendment_date="2023-07-21"),
)
