    ...
    try {
      ...
      for (var j = 0; j < els.length; j++) {
        for (var ai = 0; ai < 3; ai++) {
          ...
          if (val && T_IT[val.trim()]) els[j].setAttribute(name, T_IT[val.trim()]);
        }
      }
